package com.khalekuzzamanjustcse.dsavisulizer.pdf_generate
...
fun writePdf(context: Context, document: PdfDocument) {
    ...
    try {
        ...
        val date_suffix = "_" + dtf.format(now)
        ...
        outs = Objects.requireNonNull(pdfUri)?.let { contentResolver.openOutputStream(it) }!!
        Objects.requireNonNull(outs)
        try {
            // Write the document content
            document.writeTo(outs)
